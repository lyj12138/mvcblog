...
<div  id="login">
    <div class="form-inline"  >
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" name="fpasswd"   id="fpasswd" style="width: 100px" >
            <img id="fimg" src=""  alt=""   style="width: 100px;cursor:pointer;" onclick="getPic()"/>
            <script type="text/javascript">
                function getPic(){
                    $("#fimg").attr("src","/api/checkCode??flag="+Math.random());
                }
            </script>
