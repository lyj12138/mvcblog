...
public class CommentController {
    ...
    public @ResponseBody Object commentAdd(HttpServletRequest request) throws UnsupportedEncodingException {
        ...
        comment.setReference(Long.parseLong(request.getParameter("reference")));
        comment.setFloor(Long.parseLong(request.getParameter("floor")));
