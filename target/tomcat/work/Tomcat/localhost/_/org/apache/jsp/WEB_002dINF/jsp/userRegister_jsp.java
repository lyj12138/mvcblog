 ...
 * Generated at: 2020-12-30 07:50:43 UTC
...
public final class userRegister_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      if (_jspx_meth_c_005fif_005f0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("<h2 style=\"text-align: center;font-family: 'Adobe 楷体 Std R';color: black\">用户注册</h2>\r\n");
      ...
      out.write("        <br/><br/>\r\n");
      out.write("        <div class=\"input-group\">\r\n");
      out.write("            <span class=\"input-group-addon\">重复密码</span>\r\n");
      out.write("            <input type=\"password\" class=\"form-control\" name=\"repasswd\" id=\"repasswd\">\r\n");
      out.write("        </div>\r\n");
      out.write("        <br/><br/>\r\n");
      out.write("        <div class=\"input-group\">\r\n");
      ...
      out.write("        <br/>\r\n");
      out.write("        <button id=\"loginButton\"  class=\"btn btn-primary\">注册\r\n");
      out.write("        </button>\r\n");
      out.write("        <button id=\"tologin\" class=\"btn btn-primary\">已有账号？请点击前往登录</button>\r\n");
      out.write("\r\n");
      out.write("    </div>\r\n");
      out.write("    <script src=\"http://passport.cnblogs.com/scripts/jsencrypt.min.js\"></script>\r\n");
      out.write("    <script>\r\n");
      out.write("        var regUpper=/[A-Z]/;\r\n");
      out.write("        var regLower=/[a-z]/;\r\n");
      out.write("        var regNum=/[0-9]/;\r\n");
      out.write("        var regEmail=/^[0-9a-zA-Z_.-]+[@][0-9a-zA-Z_.-]+([.][a-zA-Z]+){1,2}$/;\r\n");
      out.write("        $(\"#username\").keyup(\r\n");
      out.write("            function(){\r\n");
      out.write("                if($(\"#username\").val()==''){\r\n");
      out.write("                    $(\"#info\").text(\"提示:用户名不能为空\");\r\n");
      out.write("                } else if($(\"#username\").val().length<3)\r\n");
      out.write("                {\r\n");
      out.write("                    $(\"#info\").text(\"提示:用户名长度必须大于3\");\r\n");
      out.write("                }\r\n");
      out.write("                else{\r\n");
      out.write("                    $(\"#info\").text(\"\");\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("        )\r\n");
      out.write("        $(\"#nickname\").keyup(\r\n");
      out.write("            function(){\r\n");
      out.write("                if($(\"#nickname\").val()==''){\r\n");
      out.write("                    $(\"#info\").text(\"提示:用户名不能为空\");\r\n");
      out.write("                } else if($(\"#nickname\").val().length<3)\r\n");
      out.write("                {\r\n");
      out.write("                    $(\"#info\").text(\"提示:昵称长度必须大于3\");\r\n");
      out.write("                }\r\n");
      out.write("                else{\r\n");
      out.write("                    $(\"#info\").text(\"\");\r\n");
      out.write("                }\r\n");
      ...
      out.write("                    $(\"#info\").text(\"提示:邮箱不能为空\");\r\n");
      out.write("                } else if(!regEmail.test($(\"#email\").val()))\r\n");
      out.write("                {\r\n");
      out.write("                    $(\"#info\").text(\"提示:邮箱格式不合法\");\r\n");
      out.write("                }\r\n");
      out.write("                else{\r\n");
      out.write("                    $(\"#info\").text(\"\");\r\n");
      out.write("                }\r\n");
      ...
      out.write("                } else if(!(regUpper.test($(\"#passwd\").val())&&regLower.test($(\"#passwd\").val())&&regNum.test($(\"#passwd\").val())&&$(\"#passwd\").val().length>=8))\r\n");
      out.write("                {\r\n");
      out.write("                    $(\"#info\").text(\"提示:密码必须为不小于八位的数字大写小写字母组合\");\r\n");
      out.write("                }\r\n");
      out.write("                else{\r\n");
      out.write("                    $(\"#info\").text(\"\");\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("        )\r\n");
      out.write("        $(\"#repasswd\").keyup(\r\n");
      out.write("            function () {\r\n");
      out.write("                if($(\"#repasswd\").val()!=$(\"#passwd\").val()){\r\n");
      out.write("                    $(\"#info\").text(\"提示:两次输入的密码不一致\");\r\n");
      out.write("                }\r\n");
      out.write("                else {\r\n");
      out.write("                    $(\"#info\").text(\"\");\r\n");
      out.write("                }\r\n");
      ...
      out.write("            if($(\"#username\").val()==''&&$(\"#passwd\").val()==''){\r\n");
      ...
      out.write("                $(\"#info\").text(\"提示:密码不能为空\");\r\n");
      out.write("            }\r\n");
      out.write("            else if($(\"#repasswd\").val()!=$(\"#passwd\").val()){\r\n");
      out.write("                $(\"#info\").text(\"提示:两次输入的密码不一致\");\r\n");
      out.write("            }\r\n");
      out.write("            else if(!(regUpper.test($(\"#passwd\").val())&&regLower.test($(\"#passwd\").val())&&regNum.test($(\"#passwd\").val())&&$(\"#passwd\").val().length>=8))\r\n");
      out.write("            {\r\n");
      ...
      out.write("            {\r\n");
      out.write("                $(\"#info\").text(\"提示:昵称不能为空\");\r\n");
      out.write("            }\r\n");
      out.write("            else if($(\"#nickname\").val().length<3)\r\n");
      out.write("            {\r\n");
      out.write("                $(\"#info\").text(\"提示:昵称长度不能小于3\");\r\n");
      out.write("            }\r\n");
      out.write("            else {\r\n");
      out.write("                $.ajax({\r\n");
      ...
      out.write("                            nickname = encrypt.encrypt($(\"#nickname\").val())\r\n");
      out.write("                            $.ajax({\r\n");
      out.write("                                type: \"POST\",\r\n");
      out.write("                                url: \"/api/registerCheck\",\r\n");
      out.write("                                data: {\r\n");
      ...
      out.write("                                    if (data.stateCode.trim() == 2) {\r\n");
      out.write("                                        $(\"#info\").text(\"提示:用户注册成功，激活创作权限需后台审核通过，跳转中...\");\r\n");
      out.write("                                        window.location.href = \"/user/main\";\r\n");
      out.write("                                    } else if (data.stateCode.trim() == 1) {\r\n");
      out.write("                                        $(\"#info\").text(\"提示:该用户名已被注册\");\r\n");
      out.write("                                    } else {\r\n");
      out.write("                                        $(\"#info\").text(\"提示:该邮箱已被注册\");\r\n");
      out.write("                                    }\r\n");
      out.write("                                }\r\n");
      out.write("                            });\r\n");
      out.write("                        }\r\n");
      ...
      out.write("\r\n");
      out.write("            location.replace(\"/user/login\");\r\n");
      out.write("\r\n");
      out.write("        })\r\n");
      out.write("    </script>\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/jsp/userRegister.jsp(52,0) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
